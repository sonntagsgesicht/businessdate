...
import os
import sys
sys.path.insert(0, os.path.abspath('../businessdate'))
sys.path.insert(0, os.path.abspath('../../businessdate'))
...
latex_documents = [
    (master_doc, 'businessdate.tex', 'Businessdate Documentation',
...
man_pages = [
    (master_doc, 'businessdate', 'Businessdate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'businessdate', 'Businessdate Documentation',
     author, 'Businessdate', 'One line description of project.',
     'Miscellaneous'),
]
